...
|---|-------|------|--------|-------|
| 1 | AI-generated code risk on the dashboard | L | Not started | Commit→Jira link, completion score, junk/risk scoring |
...
| 5 | Jira misgovernance warning | M | Not started | Hygiene score + leadership warning |
