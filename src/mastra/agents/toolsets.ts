...
/** @deprecated Use getAidosToolsForAssistant */
export const getAidosToolsForChatAssistant = getAidosToolsForAssistant;
/** @deprecated Use listAidosToolIdsForAssistant */
export const listAidosToolIdsForChatAssistant = listAidosToolIdsForAssistant;
/** @deprecated Use ASSISTANT_TOOL_IDS */
export const CHAT_ASSISTANT_TOOL_IDS = ASSISTANT_TOOL_IDS;
